...
public class ReceiptTagsRecord extends UpdatableRecordImpl<ReceiptTagsRecord> implements Record3<Integer, Integer, String> {

	private static final long serialVersionUID = -1101035616;
	 ...
	 */
	@Override
	public ReceiptTagsRecord values(Integer value1, Integer value2, String value3) {
		value1(value1);
		value2(value2);
		value3(value3);
		return this;
	 ...
	 */
	public ReceiptTagsRecord(Integer id, Integer receiptId, String tag) {
		super(ReceiptTags.RECEIPT_TAGS);
